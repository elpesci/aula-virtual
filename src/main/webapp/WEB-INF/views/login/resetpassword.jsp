...
<div id="resetPasswordBox" class="formBox clearfix prefix-1">
    <form:form method="post" action="${target}"
        ...
        <div>
            <form:label path="newPassword"><spring:message code="login.password.label"/></form:label>
            <form:password path="newPassword" autocomplete="off" cssErrorClass="fieldError" />
            <div class="fieldErrorMessage"><form:errors path="newPassword"/></div>
        </div>
        <div>
            <form:label path="confirmNewPassword"><spring:message code="login.password.label"/></form:label>
            <form:password path="confirmNewPassword" autocomplete="off" cssErrorClass="fieldError" />
            <div class="fieldErrorMessage"><form:errors path="confirmNewPassword"/></div>
        </div>
        <div>
            <button type="submit"><spring:message code="send"/></button>
