                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading clearfix">
                                    <div class="btn-group pull-right">
                                        <button type="button" class="btn btn-danger btn-sm" title="Remover pregunta"><i class="fa fa-minus-square"></i></button>
                                    </div>
...
/*
    function examMVVM (data) {
        ...
        self.loadFromJson = function() {
            var actionUrl = '<c:url value="/motorEval/examenJson"/>/' + self.examenId;
...
<script type="text/javascript">
    $(document).ready(function () {
        var mvvm = getFromServer('<c:url value="/motorEval/examenJson"/>', ${examenId});
